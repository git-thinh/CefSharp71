CoreInterface.prototype = {
    ...
    _elInputTranslate: document.getElementById('source'),
    setup: function () {
    ...
    autoSave_Update: function () {
        ...
        if (_self._hasChangeData) {
            ...
            console.log('AUTO_SAVE: ', ___DATA[___DATA_BROADCAST.Dictionary]);
        }
    },
    //========================================================================
    // DICTIONARY
    dictionary_Add: function (text, mean) {
        ...
        if (___DATA[___DATA_BROADCAST.Dictionary][text] == null) {
            ...
            console.log('DICTIONARY_ADD: ', text);
...
////////////////////////////////////////////////////////////
___DATA_BROADCAST.Dictionary = 'Dictionary';
___DATA.Dictionary = {};
///////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////
