...
namespace English
{
    public class MainContext : ApplicationContext
    {
        ...
        private const string KeyName = "EnglishMITCH";
        ...
        private void setupCompleted(object sender, EventArgs e)
        {
            ...
            //{
            //    first_time = false;
            //    main_icon.ShowBalloonTip(5000, "English will continue to run in the background", "We'll let you know when the new files have downloaded.", ToolTipIcon.Info);
            //    tm_refresh_Tick(tm_refresh, new EventArgs()); //Start our first sync
            //}
            //else
            //{
            //    login_issues = false; //Successful setup = correct login details :-)
            //    main_icon.ShowBalloonTip(5000, "Success!", "We've updated your English settings.", ToolTipIcon.Info);
        ...
        private void onSyncNowClicked(object sender, EventArgs e)
        {
            ...
            //    Sync();
            //else
            //    MessageBox.Show("English isn't connected to your Blackboard account. Have you run the setup wizard?");
        }
